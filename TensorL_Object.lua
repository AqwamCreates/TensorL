...
local function getDimensionThatHasSizeOfOneArray(dimensionSizeArray)
	
	local dimensionArray = {}
	
	for i, value in ipairs(dimensionSizeArray) do
		
		if (value == 1) then table.insert(dimensionArray, value) end
