...
local function findDimensionIndexArrayOfMaximumValue(tensor, dimensionIndexArray)
	...
	local arrayOfDimensionIndexArray = {}
	...
	if (numberOfDimensions >= 2) then
		...
		for i = 1, dimensionSizeArray[1] do 
			...
			valueArray[i], arrayOfDimensionIndexArray[i] = findDimensionIndexArrayOfMaximumValue(tensor[i], dimensionIndexArray)
		...
		for i = 1, dimensionSizeArray[1], 1 do
			...
			local copiedLocationArray = table.clone(dimensionIndexArray)
...
function AqwamTensorLibrary:findDimensionIndexArrayOfMaximumValue(tensor)
	
	
end

function AqwamTensorLibrary:findDimensionIndexArrayOfMinimumValue(tensor)
